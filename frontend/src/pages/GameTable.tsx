          ...
          {!matchOver && (
            <div className="flex items-center gap-3 bg-felt-dark/80 backdrop-blur-sm border border-gold/20 px-4 py-2 rounded-full shadow-md pointer-events-auto scale-90 origin-top-right md:scale-100">
              ...
              <div className="relative">
                ...
                {showEmoteMenu && (
                  <div className="absolute right-0 top-10 bg-felt-dark/95 border border-gold/30 rounded-2xl p-3.5 shadow-2xl flex flex-col gap-2.5 z-[100] w-64 backdrop-blur-md animate-slide-up select-none">
