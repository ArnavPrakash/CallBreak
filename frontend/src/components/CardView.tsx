  ...
  return (
    <button
      ...
      className={`${size} rounded-lg shadow-md transition-all duration-200 overflow-hidden relative select-none bg-white p-[3px]
        ...
        disabled:grayscale-[25%] disabled:hover:translate-y-0`}
    >
      <img
        src={imagePath}
...
export function CardBack() {
  return (
    <div className="w-12 h-18 sm:w-16 sm:h-24 md:w-20 md:h-28 rounded-lg shadow-md bg-red-800 border-2 border-white flex items-center justify-center relative overflow-hidden select-none">
      {/* Pattern details */}
